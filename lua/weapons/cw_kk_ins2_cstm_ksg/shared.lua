...
if CLIENT then
	...
	SWEP.IconLetter = "i"
	killicon.AddFont("cw_kk_ins_m590", "CW_KillIcons", SWEP.IconLetter, Color(255, 80, 0, 150))
	...
	SWEP.KKINS2CSTMBarskaPos = Vector(-2.3969, -4, 0.1132)
...
SWEP.Attachments = {
	...
	{header = "Extras", offset = {125, 200}, atts = {"kk_ins2_lam", "kk_ins2_flashlight"}},
	{header = "More Sight", offset = {1200, 0}, atts = {"kk_ins2_magnifier"}, dependencies = CustomizableWeaponry_KK.INS2.Magnifier_dependencies},
...
SWEP.Sounds = {
	...
	base_ready = {
		{time = 0, sound = "INS2_UNIVERSAL_DRAW"},
		{time = 26/30, sound = "INS2_M590_PUMPBACK"},
		{time = 36/30, sound = "INS2_M590_PUMPFORWARD"},
	},
	...
	base_fire = {
		...
		{time = 13/30, sound = "INS2_M590_PUMPBACK"},
		{time = 18/30, sound = "INS2_M590_PUMPFORWARD"},
	},
	...
	base_reload_insert = {
		{time = 5/36, sound = "INS2_M590_SHELLINSERT"},
	},
	...
	base_reload_end_empty = {
		...
		{time = 14/35, sound = "INS2_M590_PUMPBACK"},
		{time = 24/35, sound = "INS2_M590_PUMPFORWARD"},
	},

	iron_fire_1 = {
		// { event AE_CL_CREATE_PARTICLE_BRASS 23 ""},
		{time = 18/40, sound = "INS2_M590_PUMPBACK"},
		{time = 26/40, sound = "INS2_M590_PUMPFORWARD"},
	},
...
SWEP.ViewModel		= "models/weapons/v_cw_kk_ins_ksg.mdl"
