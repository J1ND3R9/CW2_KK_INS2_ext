...
if CLIENT then
	...
	SWEP.IconLetter = "i"
	killicon.AddFont("cw_kk_ins_toz", "CW_KillIcons", SWEP.IconLetter, Color(255, 80, 0, 150))
...
SWEP.FireDelay = 0.8
SWEP.FireSound = "INS2_TOZ_FIRE"
SWEP.FireSoundSuppressed = "INS2_TOZ_FIRE_SUPPRESSED"
SWEP.Recoil = 3
