...
if CLIENT then
	...
	SWEP.IconLetter = "i"
	killicon.AddFont("cw_kk_ins_mini14", "CW_KillIcons", SWEP.IconLetter, Color(255, 80, 0, 150))
	...
	SWEP.WM = "models/weapons/w_cw_kk_ins2_cstm_famas.mdl"
...
SWEP.Attachments = {
	...
	{header = "Extras", offset = {0, 100}, atts = {"kk_ins2_lam", "kk_ins2_flashlight"}},
	{header = "More Sight", offset = {1000, -100}, atts = {"kk_ins2_magnifier"}, dependencies = CustomizableWeaponry_KK.INS2.Magnifier_dependencies},
