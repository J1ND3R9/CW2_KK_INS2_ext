...
if CLIENT then
	...
	SWEP.IconLetter = "x"
	killicon.AddFont("cw_kk_ins_mp40", "CW_KillIcons", SWEP.IconLetter, Color(255, 80, 0, 150))
	
	SWEP.MuzzleEffect = "muzzleflash_smg"
	SWEP.Shell = "KK_INS2_9x19"
	
	SWEP.CW_GREN_model = "models/weapons/v_f1.mdl"
	SWEP.CW_GREN_pinPullAnim = "pullback_low"
	SWEP.CW_GREN_throwAnim = "throw"
	...
	SWEP.WM = "models/weapons/w_cw_kk_ins_uzi.mdl"
...
SWEP.Attachments = {
	...
	{header = "Extras", offset = {-500, 0}, atts = {"kk_ins2_lam", "kk_ins2_flashlight"}},
	{header = "More Sight", offset = {800, 0}, atts = {"kk_ins2_magnifier"}, dependencies = CustomizableWeaponry_KK.INS2.Magnifier_dependencies},
...
SWEP.Sounds = {
	base_ready = {
		...
		{time = 26/30, sound = "INS2_MP40_BOLTUNLOCK"},
	},
	...
	base_dryfire = {
		{time = 0, sound = "INS2_MP40_EMPTY"},
	},

	base_reload = {
		{time = 12/30, sound = "INS2_MP40_MAGRELEASE"},
		{time = 15/30, sound = "INS2_MP40_MAGOUT"},
		{time = 64/30, sound = "INS2_MP40_MAGIN"},
		{time = 66/30, sound = "INS2_MP40_MAGHIT"},
	},

	base_reloadempty = {
		{time = 14/30, sound = "INS2_MP40_BOLTBACK"},
		{time = 20/30, sound = "INS2_MP40_BOLTLOCK"},
		{time = 41/30, sound = "INS2_MP40_MAGRELEASE"},
		{time = 46/30, sound = "INS2_MP40_MAGOUT"},
		{time = 95/30, sound = "INS2_MP40_MAGIN"},
		{time = 97/30, sound = "INS2_MP40_MAGHIT"},
		{time = 114/30, sound = "INS2_MP40_BOLTUNLOCK"},
	},
...
SWEP.ViewModel		= "models/weapons/v_cw_kk_ins_uzi.mdl"
...
SWEP.FireSound = "INS2_MP40_FIRE"
SWEP.FireSoundSuppressed = "INS2_MP40_FIRE_SUPPRESSED"
SWEP.Recoil = 0.7
